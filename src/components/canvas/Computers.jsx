...
export default function ComputersCanvas(props) {
  return (
    <Canvas dpr={[1, 2]} camera={{ position: [-20, 40, -20], fov: 32 }}>
      <color attach="background" args={['#ffaf00']} />
      <fog attach="fog" args={['#ffaf10', 5, 10]} />
